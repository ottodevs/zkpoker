...
import { Button, type ButtonProps } from '@demox-labs/aleo-wallet-adapter-reactui/dist/Button'
import { useAccount } from '@puzzlehq/sdk'
import { useCallback, useEffect, useMemo, useRef, useState } from 'react'

export default function MultiConnectButton({ children, ...props }: ButtonProps) {
