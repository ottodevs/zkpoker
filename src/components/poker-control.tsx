...
interface PokerControlProps {
    ...
    isLoading?: boolean // Whether an action is being processed
}
...
export default function PokerControl({
    ...
    const updatePositionFromBet = useCallback(
        (bet: string | number) => {
    ...
    return (
        <div
            ...
            <div className='mx-auto flex h-full w-full max-w-[1300px] flex-col justify-between px-9 pt-4 pb-10'>
                {/* Top row - WIN and BET info with Avatar in center */}
                <div className='flex items-center justify-center gap-4'>
                    {/* WIN box */}
                    <div className='relative -mt-5 h-[47px] w-[171px]'>
                        <WinBoxBg />
                    ...
                    <div className='relative -mt-5 h-[47px] w-[171px]'>
                        ...
                        <div className='absolute inset-0 flex items-center px-4 text-white'>
                            ...
                            <div className='flex-1'>
                                <input
                                    ...
                                    className='w-full border-none bg-transparent text-right text-xl font-bold outline-none'
                        ...
                        <div className='absolute top-0 -right-[225px] mt-3'>
                            <div
                                ...
                                {/* Slider thumb */}
                                <div
                                    className={`absolute top-[-4px] z-10 -translate-x-1/2 transform ${isAllIn ? 'cursor-not-allowed' : 'cursor-grab active:cursor-grabbing'}`}
                ...
                <div className='-mt-17 flex items-center justify-between'>
                    ...
                    <div className='flex'>
                        ...
                        <div className='relative h-[66px] w-[120px]'>
                            ...
                            <button
                                className='absolute inset-0 z-10 flex cursor-pointer items-center justify-center text-[21px] font-bold text-white transition-all duration-200'
                        ...
                        {/* TIME button */}
                        <div className='relative mr-6 -ml-1 h-[66px] w-[120px]'>
                        ...
                        {/* CHECK button */}
                        <div className='relative -ml-1 h-[66px] w-[120px]'>
                        ...
                        {/* FOLD button */}
                        <div className='relative -ml-1 h-[67px] w-[170px]'>
                    ...
                    <div className='flex'>
                        {/* RAISE button */}
                        <div className='relative h-[67px] w-[171px]'>
                        ...
                        {/* CALL button */}
                        <div className='relative -ml-1 h-[67px] w-[119px]'>
                        ...
                        {/* POT button */}
                        <div className='relative ml-6 h-[67px] w-[119px]'>
                ...
                <div className='flex items-center justify-center pb-4'>
                    ...
                    <div className='relative h-[46px] w-[170px]'>
                        ...
                        <button
                            className={`absolute inset-0 z-10 flex items-center justify-center text-[21px] font-bold text-white transition-all duration-200 ${isAllIn ? 'cursor-not-allowed opacity-50' : 'cursor-pointer'}`}
                            onClick={() => {
                                if (isAllIn) return
                                const currentBet = parseInt(betAmount, 10)
                    ...
                    <div className='relative h-[70px] w-[190px]'>
                        ...
                        <div className='absolute top-0 left-1/2 h-[32px] w-[194px] -translate-x-1/2 transform'>
                        ...
                        {/* Chip count */}
                        <div className='absolute inset-0 flex items-center justify-center pt-8 text-white'>
            ...
            {/* Table information */}
            <div className='absolute bottom-0 left-0 bg-black/50 p-2 text-xs text-white'>
